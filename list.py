...
print(sorted_list)
sorted_list.insert(5,4) #Insert lets us insert something at that specific point in the list. The first digit is the location, while the sendon one is th eone one we wanna add
